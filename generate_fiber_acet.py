...
def write_lammps_data_file(num_points, occupancy_percentage, atoms, bonds, angles):
    with open("chromatin_system.data", "w") as f:
        box_side = box_side_length(num_points, occupancy_percentage) + 50
...
def assemble_linker_connections(natoms, atom_idx_start, bond_idx_start, angle_idx_start,
    ...
    if i < num_points or not last_iteration:
        ...
        bond_idx_start += 1
        angles.append(f"   {angle_idx_start:<10}{str(14):<8}{atom_idx_start-2:<10}{atom_idx_start-1:<10}{atom_idx_start+14:<10}#  Connecting DNAs\n")
        angle_idx_start += 1
        angles.append(f"   {angle_idx_start:<10}{str(14):<8}{atom_idx_start-1:<10}{atom_idx_start+14:<10}{atom_idx_start+15:<10}#  Connecting DNAs\n")
        angle_idx_start += 1
...
def generate_full_nucleosome_chain(nuc, num_points, total_nucs, step_size, radial_distance, acetylation_ratio,
    ...
    box_side = box_side_length(total_nucs, occupancy_percentage) + 50
